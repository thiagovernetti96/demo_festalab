...
RSpec.describe User, type: :model do
  it "valida o formato de email" do
    user = User.new(name: "Thiago Vernetti", email: "invalid-email", cpf: "123.456.789-01", phone: "1234567890")
    expect(user).not_to be_valid
    expect(user.errors[:email]).to include("Formato de e-mail inválido")
  end

  it "valida o formato do cpf" do
    user = User.new(name: "Thiago Vernetti", email: "thiago@example.com", cpf: "1243543534534", phone: "1234567890")
    expect(user).not_to be_valid
